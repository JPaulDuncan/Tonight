...
>
> 248 simulation tests run in under two seconds, and CI drives the built game in a
...
That boundary is what makes 248 tests run headless in under two seconds, and it is
