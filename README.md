...
> wall killable — and fight bots that shoot back, with shields, damage numbers
> and elimination. It is not yet a match: no other players, no storm running
> live, no networking.
>
> 288 simulation tests run in under two seconds, and CI drives the built game in a
...
That boundary is what makes 288 tests run headless in under two seconds, and it is
